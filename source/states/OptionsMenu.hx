...
class OptionsMenu extends MusicBeatState {
	...
	public var pages:Array<Dynamic> = [
		...
		[
			...
			new BoolOption("Optimized Intro", "introIsOptimized", 5),
			new BoolOption("Optimized Characters", "optimizedChars", 6),
			new BoolOption("Animated Backgrounds", "animatedBGs", 7),
			new BoolOption("Preload Stage Events", "preloadChangeBGs", 8),
			new BoolOption("Memory Leaks", "memoryLeaks", 9),
		],
		[
			"Info Display",
			new PageOption("Back", 0, "Graphics"),
