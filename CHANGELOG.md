...
- Girlfriend floating like in Minecraft creative mode during Winter Horrorland.
- The Void showing when Pixel Bf sings in Senpai and Roses.
...
- Unhardcoded all characters.
- Added fade effects to pixel characters.

### Optimized

- Optimized icons for Pico, Senpai, Senpai-Angry, and Bf-Pixel.
...
- Alphabet now has more stuff (like bold numbers), which I took from the Agoti mod (yes ik I didn't make it myself, but I don't have adobe animate so ¯＼*(ツ)*/¯)
